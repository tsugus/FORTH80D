...
;               |   .   |
;               |=======|
;       LIT-6 ->| 01B8H |     start of dictionary
;               |   .   |
;               |   .   |
...
UVR	DW	0		; (release No.)
	DW	8		; (revision No.)
	DW	0002H		; (user version xx[Alphabet])
	DW	INITS0		; S0
	DW	INITR0		; R0
	DW	INITS0		; TIB
	DW	31		; WIDTH
...
XDOES:	XCHG	BP,SP
	...
	; --- for ALIGN 2 ---
	ADD	SI,4H	; "E9 xxxx [padding]" is 4 bytes.
	; -------------------
